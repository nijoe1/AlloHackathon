export const STRATEGY_ABI = [
  ...
  {
    inputs: [],
    name: "INVALID_ROUND_ONE_PERCENTAGE",
    type: "error",
  },
  {
    inputs: [],
    ...
    outputs: [
      {
        components: [
          ...
          {
            internalType: "enum Types.PaidStatus",
            name: "paidOut",
            type: "uint8",
          },
          {
  ...
  {
    inputs: [],
    name: "registryIndexer",
    outputs: [
      {
        internalType: "contract IRegistryIndexer",
        name: "",
        type: "address",
      },
    ],
